...
export default function Terminal() {
  ...
  const availableCommands: Record<string, TerminalCommand> = {
    ...
    about: {
      command: "about",
      output: [
        "Denzel Selokela -Software Developer",
        "================================",
        "",
        "🚀 Passionate developer with 2+ years of experience",
        "💻 Specializing in Nextjs, Node.js, and TypeScript",
    ...
    contact: {
      ...
      output: [
        ...
        "🌐 Website:  https://denzelse.vercel.app",
    ...
    pwd: {
      command: "pwd",
      output: ["/home/denzelse/portfolio"],
      type: "success",
    },
    github: {
      command: "github",
  ...
  useEffect(() => {
    if (isOpen && commandHistory.length === 0) {
      const welcomeCommand: TerminalCommand = {
        command: "",
        output: [
          "Welcome to DenzelSE's Portfolio Terminal",
          "==========================================",
          "",
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-40 bg-blue-800 hover:bg-blue-700 text-white p-4 rounded-full shadow-lg transition-colors"
